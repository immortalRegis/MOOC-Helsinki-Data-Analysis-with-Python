...
def commute():
    ...
    august_data = bicycle_data['2017-08-01':'2017-08-31']
    weekday = august_data.index.dayofweek
    august_data['Weekday'] = weekday + 1
    august_data = august_data.reset_index().set_index('Weekday')
    grouped_data = august_data.groupby('Weekday').sum()
    return grouped_data
